...
const SpinnerOriginal = () => {
  ...
  const startUpperDisk = () => {
    ryUpperDisk.value = withTiming(15, { duration: 800 }, (finished) => {
      if (finished) {
  ...
  const startLowerDisk = () => {
    ryLowerDisk.value = withTiming(30, { duration: 800 }, (finished) => {
      if (finished) {
...
export default SpinnerOriginal;
